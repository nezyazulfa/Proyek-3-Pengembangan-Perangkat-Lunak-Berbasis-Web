...
<div class="container">
    ...
    <a href="/admin/courses/new" class="btn btn-primary">Tambah Mata Kuliah Baru</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/admin/courses/destroy/<?= $course['course_id'] ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus mata kuliah ini?')" class="btn btn-danger btn-sm">Hapus</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
